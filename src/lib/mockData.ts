...
export const mockOpportunities: Opportunity[] = [
  {
    ...
    deadline: "2025-11-20",
    description:
      "Join us in creating sustainable community gardens across San Francisco. Help plant vegetables, maintain green spaces, and teach community members about sustainable farming practices.",
    requirements: [
  ...
  },
  {
    ...
    organization: "TechHub Innovation",
