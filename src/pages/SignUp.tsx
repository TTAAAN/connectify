...
export function SignUp() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate signup - this is a demo website
    setTimeout(() => {
      setIsLoading(false);
      toast.success('Account created successfully! Welcome to Connectify!');
      navigate('/dashboard');
    }, 1500);
  };
  ...
  const handleSocialSignup = (provider: string) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      toast.success(`Account created with ${provider}! Welcome to Connectify!`);
      navigate('/dashboard');
    }, 1000);
  };
